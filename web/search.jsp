...
<body>
    <header>
        <br><br>
        <h1>Search for Fitness Classes</h1>
    </header>
...
<%
    ...
    <div>
        <form  id="searching" method="get" action="search.jsp">
            <table>
                ...
                <tr>
                    <td><label for="price">Maximum Price:</label></td>
                    <td><input type="number" id="price" name="price" min="0" step="10" ></td>
                </tr>
                
                <tr>
                    <td><label for="availability">Minimum Seats:</label></td>
                    <td><input type="number" id="availability" name="availability" min="0" step="1" ></td>
                </tr>
            ...
            <%
                ...
                try {
                    ...
                    if (availability != null && !availability.isEmpty()) {
                        query.append(" AND available_quantity >= ?");
                    }
                    ...
                    int paramIndex = 1;
                    if (name != null && !name.isEmpty()) {
                        pstmt.setString(paramIndex++, "%" + name.toLowerCase() + "%");
                    }
                    if (price != null && !price.isEmpty()) {
                        pstmt.setDouble(paramIndex++, Double.parseDouble(price));
                    }
                    if (availability != null && !availability.isEmpty()) {
                        pstmt.setInt(paramIndex++, Integer.parseInt(availability));
                    }
            ...
            <table id="result">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><%= rs.getDouble("price") %> AED</td>
                        <td><%= rs.getInt("available_quantity") %></td>
                        <td><%= rs.getTimestamp("class_datetime") %></td>
                    </tr>
                    <%
                        }
                        if (!hasResults) {
                    %>
                    <tr>
                        <td colspan="5">No results found. Please refine your search.</td>
                    </tr>
                    <%
                        }
                    %>
